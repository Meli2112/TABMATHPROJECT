...
export default function SOSFloatingButton({ onActivate }: SOSFloatingButtonProps) {
  const { user } = useAuth()
      ...
      >
        <motion.button
          ...
          className={`
            ...
            ${isPressed ? 'scale-95' : ''}
          `}
          title="Hold for 1 second to activate SOS Fight Solver"
        >
          {/* Pulse animation */}
          <motion.div
              ...
              <div className="text-center">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-lg transition-colors flex items-center justify-center space-x-2"
                  >
